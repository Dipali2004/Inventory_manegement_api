...
public class PurcheseImplementation implements PurcheseInterface {
	...
	@Override
	public Page<PurchaseRespDto> getData(int page, int size) {
		  Pageable pageable = PageRequest.of(page, size);

	        // Fetch Page<Purchase>
	        Page<Purchase> pageResult = purcheseRepo.findAll(pageable);

	        // Convert Page<Purchase> → Page<PurchaseRespDto> using mapper
	        Page<PurchaseRespDto> dtoPage = pageResult.map(purchase -> purchaseMapper.toDto(purchase));
